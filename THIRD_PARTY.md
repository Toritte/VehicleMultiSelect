...
The locally built package wraps the hash-pinned original Wwise callback bytecode. The original extracted game resource is a private build input, not a source-repository fixture.
