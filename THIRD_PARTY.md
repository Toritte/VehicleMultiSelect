...
The locally built candidate wraps the hash-pinned original boot bytecode. The original extracted game resource is a private build input, not a source-repository fixture.
